...
@param theme The theme instance used to style the card entry view controller.
@param isGiftCard Set to `true` to enter a Square gift card. Other card types are not supported in this mode.
*/
- (nonnull instancetype)initWithTheme:(nonnull SQIPTheme *)theme isGiftCard:(BOOL)isGiftCard;
